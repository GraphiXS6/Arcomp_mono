...
![image displaying IPA text](images/arcomp_mono_ipa_demo.svg)
## Editing Typeface
### File Structure
In the Arcomp_mono_git folder is an Inkscape SVG with the underline grid, and various curves used in making the glyphs.
